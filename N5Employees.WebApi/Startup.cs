...
using N5Employees.DataAccess;
using N5Employees.UnitOfWork;

namespace N5Employees.WebApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IUnitOfWork>(option => new N5EmployeesUnitOfWork(Configuration.GetConnectionString("N5Employees")));
